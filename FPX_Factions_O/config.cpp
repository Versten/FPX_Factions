class CfgPatches
{
  class FPX_Factions_O {
    ...
    units[] = {
      #include "FPX_Factions_O_CCR\CfgPatches_Units.hpp"
    };
    weapons[] = {};
    requiredAddons[] = {
      "A3_Characters_F",
...
class CfgEditorSubcategories {
  #include "FPX_Factions_O_CCR\CfgEditorSubcategories.hpp"
};
class CfgVehicles
{
	class eventhandlers;
  ...
  #include "FPX_Factions_O_CCR\CfgVehicles.hpp"
};
class CfgWeapons
{
  class Default;
  ...
  #include "FPX_Factions_O_CCR\CfgWeapons.hpp"
};
class cfgGroups {
	#include "FPX_Factions_O_CCR\CfgGroups.hpp"
};
